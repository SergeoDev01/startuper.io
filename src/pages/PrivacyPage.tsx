    ...
    <div className="w-full">
      <section className={`${section.base} pt-32`}>
        <div className={`${section.container} max-w-3xl`}>
          <h1 className={`${type.h2}`}>{t("privacyPage.title")}</h1>
          <p className="mt-2 text-sm text-[var(--text-tertiary)]">{t("privacyPage.subtitle")}</p>
        </div>
      </section>
